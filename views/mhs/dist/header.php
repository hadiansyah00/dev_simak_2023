...
if ($this->uri->segment(2) == "layout_transparent") {
  $this->load->view('mhs/dist/layout-2');
  $this->load->view('mhs/dist/sidebar-2');
}elseif ($this->uri->segment(2) == "layout_top_navigation") {
  $this->load->view('mhs/dist/layout-3');
  $this->load->view('mhs/dist/navbar');
  ...
  $this->load->view('mhs/dist/layout');
  $this->load->view('mhs/dist/sidebar');
}
?>