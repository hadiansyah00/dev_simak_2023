			...
			<div class="modal-body">
				...
				<form class="form-horizontal form" method="post" action="<?php echo base_url('mhs/profil/updateAksi') ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<input type="text" name="nama_mhs" value="<?php echo $mhs['nama_mhs']; ?>" class="form-control" required="" readonly="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<input type="number" name="hp" value="<?php echo $mhs['hp']; ?>" class="form-control" required="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<input type="text" name="asal_sekolah" value="<?php echo $mhs['asal_sekolah']; ?>" class="form-control" required="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<input type="text" name="nisn" value="<?php echo $mhs['nisn']; ?>" class="form-control" required="">
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-5 control-label no-padding-right" for="form-field-1"> Nomor Telp Orangtua / Wali</label>

						<div class="col-sm-12">
							<input type="number" name="hp_ortu" value="<?php echo $mhs['hp_ortu']; ?>" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-5 control-label no-padding-right" for="form-field-1"> Pendapatan Orangtua</label>

						<div class="col-sm-9">
							<?php $pd = $mhs['pendapatan_ortu']; ?>
							<label><input type="radio" name="pendapatan_ortu" value="Rp 500.000,00 - Rp 1.000.000,00" <?php echo ($pd == 'Rp 500.000,00 - Rp 1.000.000,00') ? "checked" : ""  ?>> >Rp 500.000,00 - Rp 1.000.000,00</label> ||
							<label><input type="radio" name="pendapatan_ortu" value="Rp 1.000.000,00 - Rp 2.000.000,00" <?php echo ($pd == 'Rp 1.000.000,00 - Rp 2.000.000,00') ? "checked" : "" ?>> >Rp 1.000.000,00 - Rp 2.000.000,00</label> ||
							<label><input type="radio" name="pendapatan_ortu" value="Rp 2.000.000,00 - Rp 3.500.000,00" <?php echo ($pd == 'Rp 2.000.000,00 - Rp 3.500.000,00') ? "checked" : ""  ?>> >Rp 2.000.000,00 - Rp 3.500.000,00</label> ||
							<label><input type="radio" name="pendapatan_ortu" value="Rp 3.500.000,00" <?php echo ($pd == 'Rp 3.500.000,00') ? "checked" : ""  ?>> > Rp 3.500.000,00</label> ||
