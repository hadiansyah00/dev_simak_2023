							...
							<div class="row">
								...
								<div class="col-md-12 col-lg-10 col-xs-12">
								   <div align="center" >
								       ...
								       <img style="width: 150px;" src="<?php echo base_url('assets/img/logo_sbh.png') ?>"></div>
								       <hr>
									<h2 class="font-32px font-weight text-blue mb-5 text-center"> Login SIAKAD</h2>
									<h3 class="font-18px font-weight text-blue mb-5 text-center padding-0">Sistem Informasi Akademik</h3>
									<hr> 
								</div>
							</div>
